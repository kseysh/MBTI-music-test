...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      {
        answer: 'a. 음악에 집중할 수 있는 이어폰이나 헤드폰으로 들어" ',
        type: [2],
      },
      {
        answer: 'b. 노래는 크게 트는게 제 맛이지, 스피커로 들어!" ',
        type: [3, 6],
      },
      {
        answer:
          'c. 항상 노래를 틀 수 있는 핸드폰을 두고 굳이..?, 핸드폰으로 들으면 되지~" ',
        type: [3, 7],
      },
    ],
  },
  {
    ...
    a: [
      ...
      {
        answer: "b. 먼저 부르는건 조금 부끄러우니 조금 있다가 불러야지",
        type: [1, 6],
      },
  ...
  },
  {
    ...
    a: [
      {
        answer: "a. 제일 유명한 대표곡부터 많이 들은 순으로 듣는다.",
        type: [0],
      },
  ...
  },
  {
    ...
    a: [
      ...
      {
        answer: "c. 야야 그 뒤에 숨겨져있는 비트가 중요한거야..!",
        type: [0, 3, 5],
      },
    ],
  },
...
const infoList = [
  {
    ...
    music: [
      "백예린 : Dear my blue",
      "잔나비 : She",
      "이강승 : 우리가 맞다는 대답을 할거에요",
      "Michael Jackson : Heal the World",
      "아이유 : 겨울잠",
      "짙은 : 잘 지내자, 우리, 잘 지내자, 우리",
      "그_냥 : 행복할거야",
      "볼빨간사춘기 : 나의 사춘기에게",
      "그_냥 : 손편지",
      "펀치 : 밤이 되니까",
  ...
  }, //istp, entp 2
  {
    ...
    music: [
      ...
      "MAX : Checklist",
      "Conan Gray : Maniac",
      "Charilie Puth : Done for Me",
      "Lil Nas X : Star Walkin",
      "Nathan Evans : Wellerman",
      "OneRepublic : I Ain't Worried",
      "Anne-Marie : 2002",
      "버스커 버스커 : 그댈 마주하는건 힘들어",
      "아이유 : Coin",
